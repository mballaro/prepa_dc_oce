...
#ssh_alongtrack = ssh_alongtrack[::3]
#time_alongtrack = time_alongtrack[::3]
#lon_alongtrack = lon_alongtrack[::3]
#lat_alongtrack = lat_alongtrack[::3]
...
if flag_reference_only:
    ...
    msk2 = np.ma.masked_where(np.abs(ssh_alongtrack) > 10., ssh_alongtrack).mask
